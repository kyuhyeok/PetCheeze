...
<tr>
<td style="border: 1px solid silver; width:200px ; padding: 10px 10px" >회원구분★</td>
<td style="padding: 10px 10px">
<input type="radio" name="회원구분"  value="개인회원" checked="checked" onclick="<%=cp%>/">개인회원
</td>
</tr>
</table>

<table style="width: 1150px; height: 50px; margin: 20px auto 0px; border-collapse: collapse;border-spacing: 0px; text-align: justify;" >
<tr>
<td style="float: left;"><b><h3>기본정보</h3></b></td>
<td style="float: right;"><b><h3>★필수입력사항</h3></b></td>
</tr>
</table>
...
<option value="nate.com" ${dto.email2=="nate.com" ? "selected='selected'" : ""}>nate.com</option>
<option value="hotmail.com" ${dto.email2=="hotmail.com" ? "selected='selected'" : ""}>hotmail.com</option>
<option value="yahoo.com" ${dto.email2=="yahoo.com" ? "selected='selected'" : ""}>yahoo.com</option>
<option value="empas.com" ${dto.email2=="empas.com" ? "selected='selected'" : ""}>empas.com</option>
<option value="korea.com" ${dto.email2=="korea.com" ? "selected='selected'" : ""}>korea.com</option>
<option value="dreamwiz.com" ${dto.email2=="dreamwiz.com" ? "selected='selected'" : ""}>dreamwiz.com</option>
...
<!-- 비밀번호 -->
<tr>
<td  style="border: 1px solid silver; width:200px ; padding: 10px 10px;" >비밀번호★</td>
<td style="padding: 10px 10px;border: 1px solid silver;">
<input type="password"  name="userPwd" style="height: 22px;">&nbsp;(영문 대소문자/숫자 4자~16자)
</td>
</tr>
<!-- 비밀번호 확인 -->
<tr>
<td  style="border: 1px solid silver; width:200px ; padding: 10px 10px;" >비밀번호 확인★</td>
<td style="padding: 10px 10px;border: 1px solid silver;">
<input type="password"  name="userPwdCheck" style="height: 22px; float: left;">
</td>
</tr>
<!-- 이름 -->
<tr>
...
<!-- 
<tr>
<td  style="border: 1px solid silver; width:200px ; padding: 10px 10px" >지역</td>
<td style="padding: 10px 10px; border: 1px solid silver; ">
<select name="fnum" style="height: 22px; width:200px;float: left;">
<option>선택</option>
<option>경기</option>
<option>서울</option>
<option>인천</option>
...
<tr>
<td style="float: left;"><b><h3>이용약관 동의</h3></b></td>
</tr>
</table>



<div style="border: 1px solid silver; width:1150px;  padding:10px; margin: 10px auto; padding-top: 20px;padding-left: 20px;padding-right: 20px" >

<div style="border: 1px solid silver; height:250px; overflow:scroll;">
...
이용약관에 동의하십니까?&nbsp;<input id="agree" name="agree" type="checkbox"  style="margin-top:20px"
...
height: 50px; margin: 10px auto 0px; border-collapse: collapse;border-spacing: 0px; text-align: justify;" >
<tr>
<td style="float: left;"><b><h3>개인정보 수집 및 이용 동의</h3></b></td>
</tr>
</table>
...
개인정보 수집 및 이용에 동의하십니까?&nbsp;<input id="agree" name="agree" type="checkbox"  style="margin-top:20px"
										onchange="form.sendButton.disabled = !checked">&nbsp;동의함
</div>
